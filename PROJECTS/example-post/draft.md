...
The visualization below breaks down a typical engagement by where the hours actually land. The model -- the part that gets all the attention -- is consistently the smallest slice.
